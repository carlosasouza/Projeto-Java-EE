...
<body>
	<center>
			<table border="1px" width="768px">
				<tr>
					<td colspan="12"><h3><center>Pedidos Para Atender</center></h3></td>
				</tr>
				<tr>
...
// 				Iteração da lista de pedidos do usuário.
					for (Pedido pedido : listaPedidos) {
						...
						out.println("<td>" + pedido.getPizza().getTipoPizza() + "</td>");
						out.println("<td>" + pedido.getPizza().getTipoMassa() + "</td>");
						...
						out.println(!pedido.getSituacao().equalsIgnoreCase("Preparo") ? "<td><a href='AtenderPedidoServlet?pedido=" + pedido.getNumero() + "'>Preparar</a></td>" : "<td><a href='DespachoPedidoServlet?pedido=" + pedido.getNumero() + "'>Despachar</a></td>");
						out.println("</tr>");
					}
				%>
				<tr>
					<td colspan="12"><center><a href="adm.jsp">Voltar</a></center></td>
				<tr>
			</table>
	</center>		
</body>
